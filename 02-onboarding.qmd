...
### Key Cards - update CAC renewal period. one year? 

ABL requires the use of the [Common Access Card (CAC)](https://sites.google.com/noaa.gov/myafsc/technology/it-security/common-access-card-cac) to access buildings and laboratories and for login to Windows and Macintosh computers. Be prepared to show your CAC to the guards at the front gate and the front door of your work building each day. Cards must be [renewed every three years](https://sites.google.com/noaa.gov/myafsc/administrative/security/cac-renewal).  
...
Office assignments are based on criteria that include time in service, highest held degree, performance, and whether an FTE or non-Federal employee. Check with ABL Admin or Division Director (Wes Larson) to see if a they have a key for your office. 
